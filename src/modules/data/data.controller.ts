...
export class DataController {
    ...
    @ApiResponse({ status: HttpStatus.CREATED, description: 'Data entry successfully created.', type: Data })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Data entries successfully retrieved.', type: [Data] })
    async findAll() {
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Data entry successfully retrieved.', type: Data })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Data entry successfully updated.', type: Data })
    @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Data entry not found.' })
